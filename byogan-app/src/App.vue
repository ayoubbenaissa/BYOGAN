<template>
  <v-app>
    ...
    <v-toolbar dark prominent style="background-image: url(../static/NN.png); background-size: cover; background-size: 100% 100%;">
      <v-toolbar-side-icon
        @click.stop="sideNav = !sideNav"
        class="hidden-sm-and-up "></v-toolbar-side-icon>
      <v-toolbar-title>
        <router-link to="/" tag="span" style="cursor: pointer">BYO-GAN</router-link>
      </v-toolbar-title>
      <v-spacer></v-spacer>
